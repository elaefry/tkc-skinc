...
def predict_result(model, run_time, probs, img):
    class_list = {'Actinic keratoses and intraepithelial carcinomae': 0, 'basal cell carcinoma': 1, 'benign keratosis-like lesions': 2, 'dermatofibroma': 3, 'melanocytic nevi': 4, 'pyogenic granulomas and hemorrhage': 5, 'melanoma': 6}
